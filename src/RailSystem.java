 ...
 * Holds references to all components and stations in the system.
 * Provides access to the complete rail network configuration.
 */
public class RailSystem {
     ...
     * Creates defensive copies of input lists to maintain encapsulation.
